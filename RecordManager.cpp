...
void RecordManager::recordPrint(char* recordBegin, int recordSize, vector<Attribute>* attributeVector, vector<string> *attributeNameVector)
{
    ...
    for(int i = 0; i < attributeVector->size(); i++)
    {
        ...
        memcpy(content, contentBegin, typeSize);
        for(j = 0; j < (*attributeNameVector).size(); j++)
        {
    ...
    cout<<endl;
    for(j=0;j<12*(*attributeVector).size();j++)
        //cout<<"- - - - - - - - - - - - ";
        cout<<"- ";
    //cout<<endl;
}
...
void RecordManager::contentPrint(char * content, int type)
{
    ...
    if (type == Attribute::TYPE_INT)
    {
        ...
        //printf("%d   ", tmp);
        cout<<" "<<setiosflags(ios::left)<<setw(20)<<tmp<<" "<<"|";
    }
    else if (type == Attribute::TYPE_FLOAT)
    {
        ...
        //printf("%f   ", tmp);
        //cout<<"|";
        //cout<<setiosflags(ios::left)<<setw(30)<<tmp<<"|";
        cout<<" "<<setiosflags(ios::left)<<setw(20)<<tmp<<" "<<"|";
    }
    else
    {
        ...
        //printf("%s   ", tmp.c_str());
        //cout<<"|";
        //cout<<"string size"<<tmp<<"*";
        //cout<<setiosflags(ios::left)<<setw(30)<<tmp.c_str()<<"|";
        cout<<" "<<setiosflags(ios::left)<<setw(20)<<tmp<<" "<<"|";
    }
